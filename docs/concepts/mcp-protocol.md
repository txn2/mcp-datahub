...
Tool annotations are optional metadata that describe a tool's behavior to AI clients. mcp-datahub sets annotations on all 12 tools:

| Annotation | Read Tools | `datahub_create` | `datahub_update` | `datahub_delete` |
|------------|:----------:|:----------------:|:----------------:|:----------------:|
| `ReadOnlyHint` | `true` | `false` | `false` | `false` |
| `DestructiveHint` | _(default)_ | `false` | `false` | `true` |
| `IdempotentHint` | `true` | `false` | `true` | `true` |
