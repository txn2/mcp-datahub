...
func TestGraphQLQueriesMatchSchema(t *testing.T) {
	...
	queries := map[string]string{
		...
		"GetRootGlossaryNodesQuery":    GetRootGlossaryNodesQuery,
		"GetRootGlossaryTermsQuery":    GetRootGlossaryTermsQuery,
		"GetGlossaryNodeChildrenQuery": GetGlossaryNodeChildrenQuery,
		"GetGlossaryParentChainQuery":  GetGlossaryParentChainQuery,
		...
		"createGlossaryNodeMutation":       createGlossaryNodeMutation,
